...
insert /*+ append parallel(4) */
  into result_swap_nwis (data_source_id, data_source, station_id, site_id, event_date, analytical_method, p_code, activity,
                         ...
                         detection_limit_desc, analysis_prep_date_tx, deprecated_flag)
select /*+ parallel(4) */
...
--       end analysis_prep_date_tx,
  ...
  from nwis_ws_star.int_qw_result r
       join activity_swap_nwis
         on r.record_no = activity_swap_nwis.activity_id
...
--            case when r.result_va = '0.0' then '0' else r.result_va end = fxd.fxd_va
       ...
       left join nwis_ws_star.int_qw_sample qw_sample
         on r.record_no = qw_sample.record_no and
